...
class ArticleTransferSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('article_url', 'source_language', 'title', 'translated_title', 'body', 'translated_body',
                  ...
                  'top_image_processed', 'processed', 'search_id', 'channel', 'status', 'locations', 'tags',)
...
class TrashFilterSerializer(serializers.ModelSerializer):
    id = serializers.IntegerField(label='ID')  # make id writable
